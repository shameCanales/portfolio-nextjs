    ...
    <>
      <div className="mt-7 sm:mt-8 md:mt-9 lg:mt-4 lg:grid lg:grid-cols-2 ">
        <div className="lg:pr-10 xl:pr-25 lg:mt-3 lg:justify-self-end">
          <p
            className={`font-medium text-xs 3xl:text-sm uppercase text-[var(--color-text-secondary)] ${outfit.className}`}
          >
            {when}
          </p>
          <p
        ...
        <div className="pl-4 sm:pl-10 md:pl-15 lg:pl-10 xl:pl-13 mt-6 3xl:mt-7 relative">
          ...
          <div>
            ...
            <ul>
              {what.map((item) => (
                <p
                  key={item}
                  className={`mt-2 3xl:mt-3 text-xs lg:text-sm 3xl:text-base leading-4.5 sm:leading-5 md:leading-6 tracking-tight 2xl:max-w-[600px] text-[var(--color-text-secondary)] ${outfit.className}`}
                >
                  {item}
                </p>
              ))}
