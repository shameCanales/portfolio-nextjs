...
export default function TechMarue() {
  return (
    <div className="flex flex-col gap-4 md:gap-8 lg:gap-10 bg-[var(--color-card)] mx-[-20px] sm:mx-[-32px] md:mx-[-48px] lg:mx-[-72px] py-4 sm:py-6 md:py-8 lg:py-10 mt-16 sm:mt-12 md:mt-14 lg:mt-18">
